export const repos = [
  {
    title: 'Aprende Python desde cero a experto',
    description:
      'Aprende Python desde cero a experto es un libro grauito para aprender Python desde cero, pensado tanto para gente sin ninguna experiencia como para aquellos que ya dominan otros lenguajes de programación.',
    languages: 'Python',
    url: 'https://github.com/jvadillo/aprende-python-desde-cero-a-experto',
    live: 'https://leanpub.com/aprende-python/',
    stars: '66',
    fork: '14',
  } /*
    {
